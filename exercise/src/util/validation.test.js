...
describe("addValidatedNumbers", () => {
  it("should return an array of numbers when an array of string number is provided", () => {
    //Arrange
    const values = ["1", "2"];
    // Act
    const transformedValues = addValidatedNumber(values);
    // Assert
    expect(transformedValues[1]).toBeTypeOf("number");
  });
